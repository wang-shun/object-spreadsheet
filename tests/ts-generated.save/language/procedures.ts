...
namespace Objsheets {
  ...
  export function parseProcedure(stringProc) {
  ...
  export function validateProcedure(proc) {
    check(proc, {
  ...
  export function typecheckProcedure(model, proc) {
  ...
  export function executeProcedure(model, proc, args) {
  ...
  export function stringifyProcedure(proc) {
