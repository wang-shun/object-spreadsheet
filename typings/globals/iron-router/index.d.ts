...
declare module Router {
  ...
  function filters(filtersMap: Object): fixmeAny;
  function filter(filterName: string, options?: Object): fixmeAny;

  // These are for Iron-Router
  function configure(config: GlobalConfig): fixmeAny;
  function map(func: Function): void;
  function route(name: string, handler?: any, routeParams?: MapConfig): fixmeAny;
