...
// This is insane: there are two copies of everything.  I guess we make our
// changes twice rather than redesigning the Meteor type definitions.
// ~ Matt 2016-09-19
...
declare type EJSONable = number | string | boolean | EJSONableArray | EJSONableDict | EJSONableBranded | Date | Uint8Array | EJSONableCustomType;
...
declare module "meteor/ejson" {
  ...
  */
  ...
  type EJSONable = number | string | boolean | EJSONableArray | EJSONableDict | EJSONableBranded | Date | Uint8Array | EJSONableCustomType;
  ...
  type JSONable = number | string | boolean | JSONableArray | JSONableDict | JSONableBranded;
...
declare module Meteor {
  ...
  */
  // Treat this like EJSON.parse.  I don't see the benefit of forcing developers
  // to use array-indexing syntax. ~ Matt 2016-09-19
  var settings: any;
  /** Global props **/
...
declare module "meteor/tools" {
  ...
  module Assets {
    // XXX: Hm, for consistency, EJSON.Binary should refer to the module-ized
    // one. But since typing is structural, it shouldn't make a difference.
    // ~ Matt 2016-09-19
    function getBinary(assetPath: string, asyncCallback?: Function): EJSON.Binary;
