...
class Model {
  ...
  public getAllColumns(columnId : any = rootColumnId) {
    ...
    let validChildren = col.children.filter(function(x) {
      return this.getColumn(x) != null;
    });
  ...
  public redefineProcedure(procId, proc) {
    ...
    Procedures.update(procId, proc);  // ignored if passed
  }
...
this.recursiveDeleteStateCellNoInvalidate = (columnId, cellId) => {
  var ce;
